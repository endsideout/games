...
export function KnowYourHealthModule6(): React.JSX.Element {
  ...
  return (
    <div
      ...
      style={{ background: "linear-gradient(135deg, #3b0764 0%, #6d28d9 40%, #a78bfa 100%)" }}
    >
      <div className="max-w-5xl mx-auto px-4">
        <div className="text-center mb-10">
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border-4 border-violet-400 inline-block">
            <div className="flex items-center justify-center mb-3">
              <Logo size="md" className="mr-4" />
              <div className="text-left">
                <p className="text-sm font-bold text-violet-600 uppercase tracking-widest">Know Your Health</p>
                <h1 className="text-3xl font-black text-gray-800">Module 6</h1>
              </div>
            </div>
            <p className="text-gray-600 text-base">Healthy habits vs. bad habits — guard your body and stay healthy!</p>
          </div>
        </div>
